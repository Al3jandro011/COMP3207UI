...
export default function EventTile({ 
    ...
    return (
        <div className="group rounded-xl bg-gray-800/50 border border-gray-700/50 shadow-lg 
                      hover:shadow-cyan-500/10 hover:border-gray-600 transition-all duration-200 
                      hover:-translate-y-1">
